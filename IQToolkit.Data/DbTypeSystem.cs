...
namespace IQToolkit.Data
{
	public static class DbTypeSystem
	{
		...
		public static DbQueryType GetQueryType(string typeName, string[] args, bool isNotNull)
		{
			...
			switch (dbType)
			{
				...
				case SqlDbType.VarChar:
					...
					else if (string.Compare(args[0], "max", StringComparison.InvariantCultureIgnoreCase) == 0)
					{
		...
		{
			if (string.Compare(typeName, "TEXT", StringComparison.InvariantCultureIgnoreCase) == 0 || string.Compare(typeName, "CHAR", StringComparison.InvariantCultureIgnoreCase) == 0
				|| string.Compare(typeName, "CLOB", StringComparison.InvariantCultureIgnoreCase) == 0 || string.Compare(typeName, "VARYINGCHARACTER", StringComparison.InvariantCultureIgnoreCase) == 0
				|| string.Compare(typeName, "NATIONALVARYINGCHARACTER", StringComparison.InvariantCultureIgnoreCase) == 0)
			{
				return SqlDbType.VarChar;
			}
			else if (string.Compare(typeName, "INT", StringComparison.InvariantCultureIgnoreCase) == 0 || string.Compare(typeName, "INTEGER", StringComparison.InvariantCultureIgnoreCase) == 0)
			{
				return SqlDbType.BigInt;
			}
			else if (string.Compare(typeName, "BLOB", StringComparison.InvariantCultureIgnoreCase) == 0)
			{
				return SqlDbType.Binary;
			}
			else if (string.Compare(typeName, "BOOLEAN", StringComparison.InvariantCultureIgnoreCase) == 0)
			{
				return SqlDbType.Bit;
			}
			else if (string.Compare(typeName, "NUMERIC", StringComparison.InvariantCultureIgnoreCase) == 0)
			{
