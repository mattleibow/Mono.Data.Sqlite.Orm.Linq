...
namespace IQToolkit
{
	...
	public class ExpressionComparer
	{
		...
		protected ExpressionComparer(
			ScopedDictionary<ParameterExpression, ParameterExpression> parameterScope, Func<object, object, bool> fnCompare)
		{
		...
		public static bool AreEqual(
			ScopedDictionary<ParameterExpression, ParameterExpression> parameterScope, Expression a, Expression b)
		{
		...
		{
			return a.NodeType == b.NodeType && a.Method == b.Method && a.IsLifted == b.IsLifted
			       && a.IsLiftedToNull == b.IsLiftedToNull && this.Compare(a.Operand, b.Operand);
		}

		protected virtual bool CompareBinary(BinaryExpression a, BinaryExpression b)
		{
			return a.NodeType == b.NodeType && a.Method == b.Method && a.IsLifted == b.IsLifted
			       && a.IsLiftedToNull == b.IsLiftedToNull && this.Compare(a.Left, b.Left) && this.Compare(a.Right, b.Right);
		}
		...
		{
			return a.Method == b.Method && this.Compare(a.Object, b.Object)
		...
		{
			return a.Constructor == b.Constructor && this.CompareExpressionList(a.Arguments, b.Arguments)
