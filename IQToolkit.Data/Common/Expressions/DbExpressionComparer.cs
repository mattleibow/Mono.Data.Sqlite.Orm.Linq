...
namespace IQToolkit.Data.Common
{
	...
	public sealed class DbExpressionComparer : ExpressionComparer
	{
		...
		public static new bool AreEqual(Expression a, Expression b)
		{
			return AreEqual(null, null, a, b, null);
		}

		public static new bool AreEqual(Expression a, Expression b, Func<object, object, bool> fnCompare)
		{
		...
		private bool CompareSelect(SelectExpression a, SelectExpression b)
		{
			...
			try
			{
				...
				return this.Compare(a.Where, b.Where) && this.CompareOrderList(a.OrderBy, b.OrderBy)
				       && this.CompareExpressionList(a.GroupBy, b.GroupBy) && this.Compare(a.Skip, b.Skip)
				       && this.Compare(a.Take, b.Take) && a.IsDistinct == b.IsDistinct && a.IsReverse == b.IsReverse
		...
		{
			return this.Compare(a.Expression, b.Expression) && this.Compare(a.Select, b.Select)
		...
		private bool CompareAggregateSubquery(AggregateSubqueryExpression a, AggregateSubqueryExpression b)
		{
			return this.Compare(a.AggregateAsSubquery, b.AggregateAsSubquery)
			       && this.Compare(a.AggregateInGroupSelect, b.AggregateInGroupSelect) && a.GroupByAlias == b.GroupByAlias;
		}
		...
		private bool CompareProjection(ProjectionExpression a, ProjectionExpression b)
		{
			...
			try
			{
				...
				return this.Compare(a.Projector, b.Projector) && this.Compare(a.Aggregator, b.Aggregator)
